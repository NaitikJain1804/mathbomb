    ...
    // Dashboard sound button
       ...
       easy.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
        	   buttonsound.start();
        	   Intent easy= new Intent("com.example.mathbomb.WILDEASY");
   	           startActivity(easy);		
           }
       });
       ...
       medium.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
        	   buttonsound.start();
        	   Intent medium = new Intent("com.example.mathbomb.WILDMEDIUM");
       ...
       hard.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
        	   buttonsound.start();
        	   Intent hard = new Intent("com.example.mathbomb.WILDHARD");
   	           startActivity(hard);		
           }
       });
   }
