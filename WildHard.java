...
public class WildHard extends Activity {
	...
	void equationgenerator(Button optone,Button opttwo,Button optthree, Button optfour, Button optfive, TextView question)
	{
		...
		nextSym=r.nextInt(4);
		sym=symbols[nextSym];
		a = r.nextInt(30 - 10) + 10;
		b=r.nextInt(50 - 20) + 20;
		if(nextSym==3)
		{
   ...
   public void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.arcade_easy);
	    ...
	    // Dashboard first option button
	       ...
	       final MediaPlayer wronganswer = MediaPlayer.create(this, R.raw.wronganswer);
	
	       equationgenerator(optone,opttwo,optthree,optfour,optfive,question);
	       
	       
	       timekeeper = new CountDownTimer(90000, 1000) {
